...
public class CopieFracture : MonoBehaviour
{
    ...
    //gasesc obiectul cu numele LevelManager
    void Start()
    {
    ...
    {
        ObjectDestroyer.objectCount--;
        Debug.Log("Object destroyed, Count= " + ObjectDestroyer.objectCount);
    ...
    {
        var fractureComponent = obj.AddComponent<CopieFracture>();
